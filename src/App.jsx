...
const filteredBills = billsss.filter((bill) =>
  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      <Route path="/" >
          <Route path="billsFeed" element={<BillsFeed bills={filteredBills} />} />
