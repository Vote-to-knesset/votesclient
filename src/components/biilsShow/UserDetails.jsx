...
const UserDetails = ({ show }) => {
  ...
  const hendelLogOut = ()=>{
    localStorage.removeItem('tokenVote'); 
    navigatLogin('/')

    

  }
  const hendelPrivteZone =()=>{
    navigatLogin('/billsFeed/votedata')
  }
  ...
  return (
    <div style={mergedStyles} className="text-black ">
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        ...
        <button style={stylesButtons} className={classNameButtons} onClick={hendelLogOut}>
          התנתק
          <svg
            fill="none"
            viewBox="0 0 24 24"
