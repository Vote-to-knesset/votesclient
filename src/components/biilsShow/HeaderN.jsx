    ...
    <header className="bg-white p-1 text-white flex items-center fixed top-0 w-full z-10  md:sticky md:top-0">
      <div className="flex items-center flex-grow">
        ...
        <div className="flex items-center flex-grow md:hidden">
          {showSearchBar ? (
            <>
              <div className="fixed top-0 left-0 w-full h-full flex  bg-black bg-opacity-80 z-50">
      ...
      <button className=" ml-4  bg-gray-300  hover:bg-gray-400 p-2 rounded-full transition duration-300 ease-in-out"
      onClick={hendelCivilClick}>
        ...
        >
          ...
          <path
            ...
            strokeMiterlimit={10}
            strokeWidth={2}
            d="M49 19h8v10h-8zM39 18v31M6 21h28M6 27h24M6 33h26"
          />
        </svg>
      </button>
      <button
