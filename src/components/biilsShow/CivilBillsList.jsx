...
const CivilBillsList = () => {
  ...
  const handleVote = async (billId, voteType) => {
    ...
    try {
      ...
      await axios.post(
        "https://sever-users-node-js.vercel.app/votes/setcivilbillvote",
        {
          billId,
          vote,
        },
                        ...
                        <div className="w-full flex flex-row h-10">
                          ...
                          <div className="relative w-full bg-gray-200 h-6 rounded-full">
                            <div
                              ...
                              style={{
                                width: `${
                                  (bill.votesInFavor.length /
                                    (bill.votesInFavor.length +
                                      bill.votesAgainst.length)) *
                                  100
                                }%`,
